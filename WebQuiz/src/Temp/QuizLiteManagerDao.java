...
public class QuizLiteManagerDao {
	 ...
	 * null - for sql Error 
	 */
	public Pair<ArrayList<QuizLite>, Integer> searchQuizLites(String search, Integer user_id, Integer quizCategoryID, int beginIndex, int count, QuizHistoryManager historyManager, Connection con) {
		...
		try {
			...
			if(quizCategoryID != null) {query += " and q.quizCategory_id = " + quizCategoryID;}
