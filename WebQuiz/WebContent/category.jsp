...
<%
    ...
    for(int i=0; i<category.length(); i++){
		if(category.charAt(i)<'0' || category.charAt(i) > '9'){
			break;
		}
		...
		<div class="content"> 
			...
			<div class="mainContent">
				...
				<%
						...
						int quizNumber = m.searchQuizLites(null, null, category_id, beginIndex, count, con).getValue();
					    ...
					    ArrayList<QuizLite> quizes = m.searchQuizLites(null, null, category_id, beginIndex, count, con).getKey();
							...
							<%
								...
								for(int i=0; i<pagesArr.size(); i++){
									...
									if(show==currentPage){
										...
										<a href="/WebQuizProject/user_quizes.jsp?page=<%= show %>&category=<%= category_id %>" ><%= show %></a>
